...
- **บันทึกรายจ่าย/ต้นทุนกิจการ** — บันทึกต้นทุนเริ่มต้น/เงินลงทุน, วัตถุดิบ, ค่าเช่า, ค่าน้ำ-ค่าไฟ, เงินเดือน, ค่าขนส่ง, การตลาด ฯลฯ แยกตามหมวดหมู่ที่ปรับแต่งเองได้ ดูสรุปตามช่วงวันที่
- **จัดการสินค้า & สต๊อก** — เพิ่ม/แก้ไข/ลบสินค้า, หมวดหมู่, บาร์โค้ด, ตัดสต๊อกอัตโนมัติเมื่อขาย, แจ้งเตือนสินค้าใกล้หมด
- **Dashboard ภาพรวมร้าน** — ยอดขาย ต้นทุนสินค้า กำไรขั้นต้น รายจ่ายอื่นๆ **กำไรสุทธิ** จำนวนบิล, กราฟยอดขายรายวัน, สินค้าขายดี Top 5, แยกยอดตามวิธีชำระเงิน, แยกรายจ่ายตามหมวดหมู่ (วันนี้ / 7 วัน / 30 วัน / เดือนนี้)
...
src/
  ...
  app/
    ...
    (app)/
      ...
      dashboard/           # ภาพรวมร้าน ยอดขาย/ต้นทุน/กำไรขั้นต้น/รายจ่าย/กำไรสุทธิ
      sales/               # ประวัติการขาย + ยกเลิกบิล
      expenses/            # รายจ่าย/ต้นทุนกิจการ + หมวดหมู่รายจ่าย
...
- `expense_categories` — หมวดหมู่รายจ่าย (ต้นทุนเริ่มต้น, วัตถุดิบ, ค่าเช่า, เงินเดือน ฯลฯ)
- `expenses` — รายจ่าย/ต้นทุนกิจการ (ไม่ผูกกับสินค้า เช่น ค่าเช่า, เงินลงทุนเริ่มต้น)
